...
class FlightSearch:
    ...
    def check_flights(self, origin_city_code, destination_city_code, from_time, to_time, destination_city):
        """Check if certain flights are available"""
        headers = {"apikey": TEQUILA_API_KEY}
        query = {
        ...
        # If there is no flights for a city It shows IndexError
        # which can be fixed by implementing Try/Except
        # By doing this we can print there is no flights.
